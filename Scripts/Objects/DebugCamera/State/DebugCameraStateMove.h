/*
 * FileName:     DebugCameraStateMove.h
 * Author:       Takao Hayata
...
#include "../DebugCameraInternals.h"
 ...
 // デバッグ用カメラの待機状態
class DebugCameraStateMove : public Systems::State<DebugCameraInternals>
{
...
private:
	...
	// マウスの移動量倍率
	static constexpr float MOUSE_COEFFICIENT = 0.001f;
